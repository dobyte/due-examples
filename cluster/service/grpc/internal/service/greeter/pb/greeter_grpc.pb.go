...
type GreeterClient interface {
	Hello(ctx context.Context, in *HelloArgs, opts ...grpc.CallOption) (*HelloReply, error)
}
...
func (c *greeterClient) Hello(ctx context.Context, in *HelloArgs, opts ...grpc.CallOption) (*HelloReply, error) {
...
type GreeterServer interface {
	Hello(context.Context, *HelloArgs) (*HelloReply, error)
...
func (UnimplementedGreeterServer) Hello(context.Context, *HelloArgs) (*HelloReply, error) {
...
func _Greeter_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Hello(ctx, req.(*HelloArgs))
	}
